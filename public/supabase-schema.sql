...
-- ==============================================================================
-- 1. TABEL UTAMA (URUTAN DEPENDENCY FOREIGN KEY)
-- ==============================================================================
...
CREATE TABLE IF NOT EXISTS public.teacher_profiles (
  ...
  mata_pelajaran_utama TEXT DEFAULT 'Konsentrasi Keahlian TKJ',
...
-- ==============================================================================
-- 2. INDEKS PERFORMA & QUERY FAST-LOOKUP
-- ==============================================================================
...
CREATE INDEX IF NOT EXISTS idx_students_no ON public.students(class_id, no);
...
CREATE INDEX IF NOT EXISTS idx_grade_columns_user_id ON public.grade_columns(user_id);
...
CREATE INDEX IF NOT EXISTS idx_public_shares_class_id ON public.public_shares(class_id);
CREATE INDEX IF NOT EXISTS idx_public_shares_user_id ON public.public_shares(user_id);
...
-- C. STUDENTS (Ownership divalidasi melalui relasi: class_id -> classes.user_id = auth.uid())
...
-- ==============================================================================
-- 4. REALTIME PUBLICATION (UNTUK UPDATE OTOMATIS)
-- ==============================================================================
DO $$
BEGIN
  IF NOT EXISTS (
...
-- ==============================================================================
-- Memastikan PostgREST langsung mengenali seluruh tabel baru tanpa delay cache
